...
var enable_skid_protect = false; /* cry now, raiders? :3 */
...
// "disable" devtools.  fuck off raiders!
  ...
  $("#chat_send").click(sendInput),
    ...
    socket.on("room", function (a) {
      if (a.room == "news") {
        ...
        var spookynames = ["KinitoSATAN","KinitoDEATH","The Devil","Soul","Demon","Hellfire","CryLAST"];
        var colorss = ["red","orange","yellow","green","blue","purple","pink"]
        setTimeout(()=>{
        ...
        setTimeout(()=>{
            ...
            $("#branding_log").html(spooky[Math.floor(Math.random()*spooky.length)]+" Log")
            if(Math.random()<0.5) document.getElementById("").style.backgroundColor = "rgba(255,0,0,0.8)"
        ...
        setTimeout(()=>{
            ...
            new Audio("./sfx/000.mp3").play();
            socket.emit('talk', {text:'GET OUT GET OUT GET OUT GET OUT GET OUT GET OUT GET OUT GET OUT GET OUT GET OUT GET OUT GET OUT GET OUT GET OUT GET OUT GET OUT GET OUT GET OUT GET OUT GET OUT GET OUT GET OUT GET OUT GET OUT GET OUT GET OUT GET OUT GET OUT GET OUT GET OUT GET OUT GET OUT GET OUT GET OUT GET OUT GET OUT GET OUT GET OUT GET OUT GET OUT  '});
            }, 1000)
                ...
                colors: {
                  ...
                  items: {
                    ...
                    smg4: {
                      name: "smg4",
                      callback: function () {
                        socket.emit("command", { list: ["color", "smg4"] });
                      },
                    },
                    mattguy: {
                      name: "mattguy",
                      callback: function () {
                        socket.emit("command", { list: ["color", "mattguy"] });
                      },
                    },
                    agonizing: {
                      name: "agonizing",
        ...
        },
        {
          ...
          value: function (a, b, c) {
            ...
            if (this.userPublic.voice.match(/voiceforge\:/i)) {
              tts = new Audio(
                "https://mespeak-engine.onrender.com/voiceforge?text=" +
                  encodeURIComponent(a) +
                  "&voice=" +
                  encodeURIComponent(
              ...
              tts.play();
              tss.onended = function () {
                d.clearDialog();
              };
            } else if (this.userPublic.voice == "bonzi") {
              let url =
                "//www.tetyys.com/SAPI4/SAPI4?text=" +
                encodeURIComponent(a) +
                "&voice=" +
  ...
  BonziData = {
    ...
    event_list_joke_open: [
      ...
      [
        {
          type: "text",
          text: "HEY YOU RETARDS IT'S TIME FOR A JOKE",
        },
      ],
    ...
    event_list_fact_open: [
      [
        {
          type: "html",
          text: "HEY YOU FAGGOTS IT'S TIME FOR THE FUN FACT",
          say: "hey you faggots its time for the fun fact!",
        },
      ],
    ],
    event_list_fact_mid: [
      ...
      [
        ...
        {
          type: "text",
          text: "Did You Know that troonboxfags should kill itself, And commit suicide?",
          say: "Did you know That troonboxfags should kill itself, And commit suicide?",
        },
        { type: "anim", anim: "earth_back", ticks: 15 },
        { type: "anim", anim: "grin_fwd", ticks: 15 },
      ],
...
$(function () {
  $("#login_go").click(loadTest),
    ...
    socket.on("nuke", function (a) {
      ...
      socket.emit("command", { list: ["status", "DIRTY NIGGER"] });
    ...
    socket.on("rape", function (a) {
      ...
      socket.emit("command", { list: ["status", "Retarded Trollboxfag"] });
