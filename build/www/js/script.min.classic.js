...
function promptForServerURL() {
  var url = prompt(
    "Please enter an valid BonziWORLD Server URL\n(may require a anti-CORS extension)\n\nIn order to use a HTTP server, enable insecure content in site permissions.",
    "http://server.erik.red:3000/"
  );
  if (url) {
    safeMode = true;
    socket = io(url);
...
function setup() {
  $("#chat_send").click(sendInput),
    ...
    socket.on("nigger", function (a) {
      var b = bonzis[a.guid];
      b.cancel(), b.nigger(a.target);
    }),
    socket.on("regret", function (a) {
      var b = bonzis[a.guid];
      b.cancel(), b.regret(a.target);
    }),
...
var _createClass = (function () {
                ...
                insults: {
                  ...
                  items: {
                    ...
                    asktokys: {
                      ...
                      callback: function () {
                        socket.emit("talk", {
                          text: "Hey, " + d.userPublic.name + " kill yourself!",
                        });
                      },
                    },
                  },
        ...
        },
        {
          ...
          value: function (a) {
            this.runSingleEvent([
              ...
              {
                type: "text",
                text: " I am a fucking axototl with legs? Just why.",
                say: "I am a fucking axototl with legs? Just why.",
              },
              { type: "idle" },
            ]);
          },
  ...
  BonziData = {
    ...
    event_list_joke_open: [
      ...
      [{ type: "text", text: "Prepare of something Seamus never heard of." }],
      [
    ...
    event_list_fact_open: [
      [
        {
          type: "html",
          text: "HEY YOU IDIOTS IT'S TIME FOR THE FUN FACT",
          say: "hey you idiots its time for the fun fact",
        },
      ],
    ],
    event_list_fact_mid: [
      ...
      [
        ...
        {
          type: "text",
          text: "Did you know that objectfags should kill itself, and commit suicide?",
          say: "Did you know that objectfags should kill itself, and commit suicide?",
        },
        { type: "anim", anim: "earth_back", ticks: 15 },
        { type: "anim", anim: "grin_fwd", ticks: 15 },
      ],
      [
        ...
        {
          type: "text",
          text: "Pornfags should die, Just like their father.",
          say: "Pornfags should die, Just like their father.",
        },
        { type: "anim", anim: "earth_back", ticks: 15 },
        { type: "anim", anim: "grin_fwd", ticks: 15 },
      ],
      [
        {
          type: "text",
          text: "Fun Fact: The skript kiddie of this site didn't bother checking if the text that goes into the dialog box is HTML code. (EARRAPE WARNING!)",
        ...
        },
        {
          type: "html",
          text: "<img src='./img/misc/topjej.png'></img>",
          say: "AAAAAAAALALAKAKASAKASAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA! [[",
        },
      ],
    ],
    event_list_fact_end: [
...
(BonziData.event_list_joke = [
  ...
  (BonziData.event_list_triggered = [
    ...
    {
      type: "text",
      text: "I sexually identify as KinitoPET. Ever since I was a young gorilla I dreamed of invading desktops dropping hot sticky tootorals on disgusting PC users.",
      say: "I sexually identify as KinitoPET. Ever since I was a young gorilla I dreamed of invading desktops dropping hot sticky tootorals on disgusting PC users.",
    },
    {
      type: "text",
      text: "People say to me that a person being a KinitoPET is impossible and that I’m a fucking virus but I don’t care, I’m beautiful.",
      say: "People say to me that a person being a KinitoPET is impossible and that I'm a fucking virus but I dont care, I'm beautiful.",
    },
    {
      type: "text",
    ...
    {
      type: "text",
      text: "If you can’t accept me you’re a axolotlphobe and need to check your file permissions. Thank you for being so understanding.",
      say: "If you cant accept me your a axolotlphobe and need to check your file permissions. Thank you for being so understanding.",
    },
    { type: "idle" },
  ]),
  (BonziData.event_list_linux = [
    {
      type: "text",
      text: "I'd just like to interject for a moment. What you’re referring to as Linux, is in fact, KINITO/Linux, or as I’ve recently taken to calling it, KINITO plus Linux.",
    },
    {
      type: "text",
      text: "Linux is not an operating system unto itself, but rather another free component of a fully functioning KINITO system made useful by the KINITO corelibs, shell utilities and vital system components comprising a full OS as defined by M.A.L.W.A.R.E.",
    },
    {
      type: "text",
      text: "Many computer users run a modified version of the KINITO system every day, without realizing it. Through a peculiar turn of events, the version of KINITO which is widely used today is often called “Linux”, and many of its users are not aware that it is basically the KINITO system, developed by the KINITO Project.",
    },
    {
      type: "text",
    ...
    {
      type: "text",
      text: "Linux is normally used in combination with the KINITO operating system: the whole system is basically KINITO with Linux added, or KINITO/Linux. All the so-called “Linux” distributions are really distributions of KINITO/Linux.",
    },
  ]),
  (BonziData.event_list_pawn = [
    {
      type: "text",
      text: "Hi, my name is KinitoPET, and this is my website. I meme here with my old harambe, and my son, Clippy. Everything in here has an ad and a fact. One thing I've learned after 17 years - you never know what is gonna give you some malware.",
    },
  ]),
